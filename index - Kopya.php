...
<body>
    ...
    <div class="game-container">
        <?php if (isset($_SESSION['username'])): ?>
            <div class="info">
				...
				<p class="puan-text" style="color: white;"><i class="fas fa-coins"></i><span id="score"><?php echo number_format($userScore, 2); ?></span></p>				<p class="icon-text"><i class="fas fa-hand-point-up"></i> : <?php echo htmlspecialchars($userLevel); ?></p>
            ...
            <div class="circle-container">
				<div class="circle" style="background-color: black;">
					<img id="dynamicImage" src="images/ezgif.gif" alt="Description of your image" style="max-width: 100%; max-height: 100%; object-fit: contain;">
				</div>
			</div>
			...
			<form action="game.php" method="post">
				<button class="fas fa-star" id="gameStart" type="submit">Oyna</button>
			</form>
			<?php endif; ?>
	...
	<div id="announcement" class="announcement">
		<div class="announcement-content">
			...
			<p>Yenilenmesi için 00:00' ı beklemelisin.</p>
		</div>
                ...
                success: function(response) {
                    ...
                    if (response.status === 'success') {
                        ...
                        if (response.score > 100000 && response.score < 1000000) {
                            $('#dynamicImage').attr('src', 'images/ezgif2.gif');
                        } else if (response.score > 1000000) {
                            $('#dynamicImage').attr('src', 'images/ezgif3.gif');
                        } else {
                            $('#dynamicImage').attr('src', 'images/ezgif.gif');
                        }
                    }
                }
            });
