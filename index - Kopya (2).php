        ...
        <?php if (isset($_SESSION['username'])): ?>
            ...
            <div class="circle-container">
				<div class="circle" style="background-color: black;">
					<img id="dynamicImage" src="images/hero_passive.gif" alt="Description of your image" style="max-width: 100%; max-height: 100%; object-fit: contain;">
				</div>
			</div>
			...
			<?php if ($game > 0): ?>
			<a href="game.php">
				<img src="images/game.png" alt="Play Game" style="width: 100px; height: 100px; margin-top: 0px;">
			</a>
			<?php endif; ?>
    ...
    <script>
        ...
        document.querySelector(".circle").addEventListener("pointerdown", function(event) {
			...
			if (energy <= pointsPerClick) {
				...
				$('#dynamicImage').attr('src', 'images/hero_active.gif');
